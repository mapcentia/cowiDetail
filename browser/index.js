...
var createBufferBtn = function () {
    // Create buttons
    var isochroneSubAction = LeafletToolbar.ToolbarAction.extend({
    ...
    // Create buttons
    var ImmediateSubAction2 = LeafletToolbar.ToolbarAction.extend({
        initialize: function (map, myAction) {
            this.map = cloud.get().map;
            this.myAction = myAction;
            LeafletToolbar.ToolbarAction.prototype.initialize.call(this);
    ...
    var ghybrid = ImmediateSubAction2.extend({
        ...
        addHooks: function () {
            setBaseLayer.init("luftfotoserier2017");
            ImmediateSubAction2.prototype.addHooks.call(this);
        }
    });
    ...
    return new LeafletToolbar.Control({
        position: 'topright',
...
module.exports = {
    ...
    init: function () {
        ...
        backboneEvents.get().on("end:state", function () {
            cloud.get().addBaseLayer("geodkBright", "luftfotoserier2017", {
                "maxZoom": 18,
                "maxNativeZoom": 18,
            ...
            cloud.get().addBaseLayer("luftfotoserier2017", {
                "maxZoom": 18,
                "maxNativeZoom": 18,
                "attribution": "Tiles by <a href='http://cowi.dk' target='_blank'>COWI</a> | Data by <a href='http://www.openstreetmap.org/' target='_blank'>OpenStreetMap</a>"
                //"subdomains": ["a", "b", "c"]
